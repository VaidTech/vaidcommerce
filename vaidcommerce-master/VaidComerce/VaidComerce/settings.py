"""
Django settings for VaidComerce project.
...
SECRET_KEY = 'n@4nl5d(tan+$=c#0palamin1232!$(dhzf^dch(ku-h%@qmg!*!+7+22*gp' #deploy
...
WSGI_APPLICATION = 'VaidComerce.wsgi.application'
